globals [
  ...
  money           ;; money get with the exploitation of wood
]
...
to setup
  ...
  ask patches with [(random-float 100) < densite_initiale]
    [ set pcolor green ]
...
481
141
densité d'arbres encore vivants
densite_initiale - (burned-trees / initial-trees) * densite_initiale
1
1
11
