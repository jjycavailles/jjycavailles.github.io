...
to flock  ;; turtle procedure
  ...
  if any? flockmates
    [ find-nearest-neighbor
      ifelse distance nearest-neighbor < separation-minimum
        [ separate ]
        [ align
          cohere ] ]
end
...
to separate  ;; turtle procedure
  turn-away ([heading] of nearest-neighbor) virage-separation-maximal
end

;;; ALIGN

to align  ;; turtle procedure
  turn-towards average-flockmate-heading virage-alignement-maximal
end
...
to cohere  ;; turtle procedure
  turn-towards average-heading-towards-flockmates virage-coherence-maximal
end
